 ...
 */
declare export interface ReducersMapObject {
...
*/
declare export function combineReducers<S>(reducers: ReducersMapObject): Reducer<S >
    /**
 ...
 */
declare export interface Unsubscribe {
    (): void
}
/**
 ...
 * @template  State object type.
*/
declare export interface StoreCreator {
...
*/
declare export type StoreEnhancer<S>= (next: StoreEnhancerStoreCreator<S>) => StoreEnhancerStoreCreator<S>;
declare export type GenericStoreEnhancer =<S>(next: StoreEnhancerStoreCreator<S>) => StoreEnhancerStoreCreator<S>;
declare export type StoreEnhancerStoreCreator<S>= (reducer: Reducer<S>, preloadedState?: S) => Store<S>;
declare export var createStore: StoreCreator;
declare export interface MiddlewareAPI<S>{
    dispatch: Dispatch<S>,
    getState(): S
}
/**
...
*/
declare export function applyMiddleware(...middlewares: Middleware[]): GenericStoreEnhancer
/**
...
*/
declare export interface ActionCreator<A>{
    (...args: any[]): A
}
/**
 * Object whose values are action creator functions.
 */
declare export interface ActionCreatorsMapObject {
...
*/
declare export function bindActionCreators<A>(actionCreator: A, dispatch: Dispatch<any>): Adeclare type Func0<R>= () => R;
...
`(...args) => f(g(h(...args)))`.
*/
declare export function compose():<R>(a: R) => R